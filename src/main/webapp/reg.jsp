...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    ...
    <body>
        ...
        <form action="doctorcode.jsp" method="post">
          <header><h1>Doctor Registration Form</h1></header>  
            <div class="container">
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter your Specialty" name="Specialty">
                    </div>
                    
                    <div class="form-group">
                      <label for="qualifications">qualifications</label>
                      <input type="text" class="form-control" placeholder="Enter your qualifications" name="qualifications">
                    </div>
            ...
            <input type="number" class="form-control" id="experience" name="experience" min="0" required>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter your Phone Number" name="phno">
                    </div>  
